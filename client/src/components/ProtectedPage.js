...
function ProtectedPage({ children }) {
  ...
  return (
    user && (
      <div class="">
        {/* header */}
        <header class="flex items-center justify-between p-4 md:p-8 drop-shadow-xl">
          {/* <!-- logo - start --> */}
          <a
            href="/"
          ...
          >
            <img
              src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEib4oiizqd86W6be3zId3phsGR9u0b58VEs31GJQ6l6kl-8ifAtGPmMyC842pIWNmP5Swht_bClKfSgJ9JmmnfVwa41pE4UIw1FRLJZoLuuTdPnYLccQACns4eVE1v7LM4cZoAA5_NTCNKkyOwQIKzCY7ibwuvYvCqOjrf15ldpAd-jx0Fgm1twoY5hfg/s80/wepik-export-20230501113911.png"
              alt="logo"
            />
            MARKETPLACE
          </a>
          ...
          <div class="pt-12 lg:pt-16">
            <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
              ...
              <div class="border-t py-8 text-center text-sm text-gray-400">
                © 2022 - Market Place. All rights reserved.
              </div>
            </div>
          </div>
        </footer>
